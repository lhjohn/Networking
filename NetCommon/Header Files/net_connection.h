...
namespace lhj {
  namespace net {
    ...
    class connection : public std::enable_shared_from_this<connection<T>> {
      public:
                   ...
                   : m_asioContext(asioContext), m_socket(std::move(socket)), m_qMessagesIn(qIn)
        {
          ...
          if (m_nOwnerType == owner::server) {
            ...
            // Pre-calculate the result for checking the client responds
      ...
      public:
        void ConnectToClient(lhj::net::server_interface<T>* server, uint32_t uid = 0)
        {
          if (m_nOwnerType == owner::server)
          {
            if (m_socket.is_open())
            {
              ...
              // Next, issue a tast to sit and wait asynchronously for precisely
              // the validation data set back from the client
      ...
      public:
        ...
        void ReadValidation(lhj::net::server_interface<T>* server = nullptr) {
            ...
            [this, server](std::error_code ec, std::size_t length) {
              if (!ec) {
                if (m_nOwnerType == owner::server) {
                  ...
                  // Connection is a client, so solve puzzel
      ...
      protected:
        ...
        // This queue holds all messaged to be sent to the remote side
        // of the connection
